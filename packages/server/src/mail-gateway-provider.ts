...
import { ILogService, LogService } from "./services/log-service.js";
import { IMailService, MailService } from "./services/mail-service.js";
import { IConfigService, ConfigService } from "./services/config-service.js";
import {
  ITestBedKafkaService,
  TestBedKafkaService,
} from "./services/test-bed-kafka-service.js";
import {
  IPostfixMailServerManagementService,
  PostfixMailServerManagementService,
} from "./services/postfix-mailserver-management.js";
import {
...
export class MailGatewayProvider {
  ...
  constructor() {
    ...
    this.kafkaTestBedService = new TestBedKafkaService(
      this.logService,
      this.configService
    );
    this.postfixService = new PostfixMailServerManagementService(
      this.logService,
      this.configService
    );
    this.mailGatewayService = new MailService(
      this.logService,
      this.configService,
      this.kafkaTestBedService,
      this.postfixService
    );
  ...
  public GetStatus(): any {
    ...
    return {
      ...
      status: {
        ...
        receivedKafkaPost:
          this.TestBedKafkaService.numberOfReceivedSimEnityPost,
