...
import mailAddressesParser from "nodemailer/lib/addressparser/index.js";
...
export function mailAddressConverterSingle(
  mailAddress: string | Address | undefined
): Address | undefined {
...
// Convert to adress to string
export function mailAddressConverterSingleToString(
  mailAddress: string | Address | undefined
): string {
...
export function mailAddressConverterToString(
...
export function mailAddressConverter(
  mailAddress: string | Address | Array<string | Address>
): Address[] {
  if (mailAddress) {
