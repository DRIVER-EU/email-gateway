 ...
 * @export
 */
export const MailManagementApiFetchParamCreator = function (
  configuration?: Configuration
) {
  return {
    /**
    ...
    addAccount(
      ...
      if (Password === null || Password === undefined) {
        throw new RequiredError(
          "Password",
          "Required parameter Password was null or undefined when calling addAccount."
        );
      }
      ...
      if (Account === null || Account === undefined) {
        throw new RequiredError(
          "Account",
          "Required parameter Account was null or undefined when calling addAccount."
        );
      }
    ...
    deleteAccount(Account: string, options: any = {}): FetchArgs {
      ...
      if (Account === null || Account === undefined) {
        throw new RequiredError(
          "Account",
          "Required parameter Account was null or undefined when calling deleteAccount."
        );
      }
...
export const MailManagementApiFp = function (configuration?: Configuration) {
  return {
    ...
    addAccount(
      ...
      Account: string,
      options?: any
    ): (fetch?: FetchAPI, basePath?: string) => Promise<AddMailAccountResult> {
      const localVarFetchArgs = MailManagementApiFetchParamCreator(
        configuration
      ).addAccount(Password, Account, options);
      return (
    ...
    mailAccounts(
      options?: any
    ): (fetch?: FetchAPI, basePath?: string) => Promise<MailAccountsResult> {
      const localVarFetchArgs =
        MailManagementApiFetchParamCreator(configuration).mailAccounts(options);
      return (
        fetch: FetchAPI = portableFetch,
        basePath: string = BASE_PATH
      ) => {
    ...
    resetbase(
      options?: any
    ): (fetch?: FetchAPI, basePath?: string) => Promise<ResetResult> {
      const localVarFetchArgs =
        MailManagementApiFetchParamCreator(configuration).resetbase(options);
      return (
        fetch: FetchAPI = portableFetch,
        basePath: string = BASE_PATH
      ) => {
 ...
 * @export
 */
export const MailManagementApiFactory = function (
  configuration?: Configuration,
  fetch?: FetchAPI,
  basePath?: string
) {
  return {
    ...
    addAccount(Password: string, Account: string, options?: any) {
      return MailManagementApiFp(configuration).addAccount(
        Password,
        Account,
        options
      )(fetch, basePath);
    ...
    deleteAccount(Account: string, options?: any) {
      return MailManagementApiFp(configuration).deleteAccount(Account, options)(
        fetch,
        basePath
      );
    },
    ...
    mailAccounts(options?: any) {
      return MailManagementApiFp(configuration).mailAccounts(options)(
        fetch,
        basePath
      );
    },
    ...
    resetbase(options?: any) {
      return MailManagementApiFp(configuration).resetbase(options)(
        fetch,
        basePath
      );
    },
...
export class MailManagementApi extends BaseAPI {
  ...
  public addAccount(Password: string, Account: string, options?: any) {
    return MailManagementApiFp(this.configuration).addAccount(
      Password,
      Account,
      options
  ...
  public deleteAccount(Account: string, options?: any) {
    return MailManagementApiFp(this.configuration).deleteAccount(
      Account,
      options
    )(this.fetch, this.basePath);
  }
  ...
  public mailAccounts(options?: any) {
    return MailManagementApiFp(this.configuration).mailAccounts(options)(
      this.fetch,
      this.basePath
    );
  }
  ...
  public resetbase(options?: any) {
    return MailManagementApiFp(this.configuration).resetbase(options)(
      this.fetch,
      this.basePath
    );
  }
